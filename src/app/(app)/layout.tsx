...
export default function AppLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <>
      ...
      <button
        onClick={() => openQuickAdd()}
        className="hidden lg:flex fixed bottom-6 right-24 z-40 h-14 w-14 items-center justify-center rounded-full bg-primary text-white hover:bg-primary-hover hover:scale-110 active:scale-95 transition-all duration-200 neon-border"
