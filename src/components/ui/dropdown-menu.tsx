...
>(({ className, sideOffset = 6, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cn(
        "z-[100] min-w-[10rem] overflow-hidden rounded-xl border border-border bg-popover/95 backdrop-blur-xl p-1 text-text shadow-2xl",
...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Label
    ref={ref}
    className={cn(
      "px-3 py-2 text-[10px] font-bold uppercase tracking-wider text-text-muted",
      inset && "pl-8",
      className,
    )}
    {...props}
