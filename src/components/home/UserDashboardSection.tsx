...
export function UserDashboardSection() {
  const { items, loading, error, reload } = useOptionalLibrary();
    ...
    <section className="relative py-12 md:py-16">
      <div className="mx-auto max-w-6xl px-6 flex flex-col gap-10">
        ...
        <div className="flex items-center justify-between border-b border-white/5 pb-4">
          <div>
            <span className="mb-1 inline-block rounded-full border border-primary/20 bg-primary/5 px-3 py-0.5 text-[10px] font-bold uppercase tracking-widest text-primary">
              Bảng theo dõi cá nhân
            </span>
            <h2 className="text-2xl font-extrabold tracking-tight md:text-3xl">
              Thư Viện Phim Của Bạn
            </h2>
          </div>
              ...
              <CardContent className="flex items-start gap-4 p-5">
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <p className="text-sm leading-relaxed text-text-secondary">
                    ...
                    <span className="font-semibold text-text">{forgotten.mediaItem.title}</span>{" "}
                    (lần cuối {daysSince(forgotten.lastWatchedAt)} ngày trước). Đọc lại tóm tắt
                    không spoil để tiếp tục.
                  </p>
        ...
        {/* MAIN LAYOUT: Left Movies + Right Sidebar */}
